  ...
  return <>
    ...
    <ol className="relative border-s border-gray-200 dark:border-gray-700">
      ...
      <li className="mb-10 ms-4">
        ...
        <p className="text-base font-normal text-gray-500 dark:text-gray-400">All of the pages and components are first
      ...
      <li className="ms-4">
        ...
        <p className="text-base font-normal text-gray-500 dark:text-gray-400">Get started with dozens of web components
